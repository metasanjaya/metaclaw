 ...
 * 
 * Format: [KNOW: {"tags":["server","proxy"], "fact":"Server proxy di 172.237.88.87"}]
 * Delete: [KNOW: {"delete":"server-proxy-pakdeslot"}]
 * Update: [KNOW: {"id":"server-proxy-pakdeslot", "tags":[...], "fact":"..."}]
 */
