...
- **Repository:** github.com/metasanjaya/PROJECT_PLATFORM-net
- **Status:** Deployed to staging, database migrated ✅

### Deployment
- **Staging:** STAGING_IP (Laravel Forge)
- **User:** PROJECT_PLATFORM-dev
- **Branch:** development (active) → merge to main for production
- **Database:** MariaDB - 31 migrations completed
- **SSH Access:** Masita has PROJECT_PLATFORM_forge key
...
- ✅ Created TestUserSeeder (test@PROJECT_PLATFORM.dev, admin@PROJECT_PLATFORM.dev)
...
- **Z (M's Assistant @Ular39)** = Specialized agent (PROJECT_APP projects, client ops)
...
- **Paths:** `/root/metaclaw/` (Nayla), `/root/metaclaw-instance2/` (Arifin)
- **PM2:** `metaclaw-instance1`, `metaclaw-instance2`
...
- **GitHub:** Private repo at github.com/metasanjaya/PROJECT_BROWSER ✅
- **VPS:** BUILD_SERVER_IP (Chromium source + builds)
- **Current Blocker:** Sub-agent patches have Chromium anti-patterns (unsafe buffers, extra braces, wrong containers)
- **Location:** /projects/PROJECT_BROWSER/ + VPS /root/PROJECT_BROWSER/
...
- **Status:** v1.7.0 live, running via `pm2 metaclaw-instance1`
