...
### Example:
After `ssh -p 22 root@172.237.72.136` works:
```
knowledge(action: "add", fact: "SSH to 172.237.72.136: port 22, user root, key /root/.ssh/ular28-db-setup", tags: ["ssh", "ular28", "server"])
```
