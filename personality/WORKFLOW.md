...
- **Home:** /root/metaclaw-main
- **Workspace:** /root/metaclaw-main/workspace
- **Skills:** /root/metaclaw-main/skills
- **Data:** /root/metaclaw-main/data
- **Personality:** /root/metaclaw-main/personality
- **Config:** /root/metaclaw-main/config.yaml (config.local.yaml overrides)
...
**Simpan fact:**
`[KNOW: {"tags":["server","proxy"], "fact":"Server proxy: PROXY_SERVER_IP"}]`
